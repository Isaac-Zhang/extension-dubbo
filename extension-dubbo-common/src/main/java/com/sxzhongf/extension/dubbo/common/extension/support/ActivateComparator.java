package com.sxzhongf.extension.dubbo.common.extension.support;

import com.sxzhongf.extension.dubbo.common.extension.Activate;
...
public class ActivateComparator implements Comparator<Object> {
    ...
    public int compare(Object o1, Object o2) {
        ...
        if ((a1.applicableToCompare() || a2.applicableToCompare()) && inf != null) {
            ExtensionServiceLoader<?> extensionLoader = ExtensionServiceLoader.getExtensionServiceLoader(inf);
