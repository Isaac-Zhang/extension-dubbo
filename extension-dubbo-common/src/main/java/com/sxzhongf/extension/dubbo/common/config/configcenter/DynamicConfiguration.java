...
import static com.sxzhongf.extension.dubbo.common.config.configcenter.DynamicConfigurationFactory.getDynamicConfigurationFactory;
...
public interface DynamicConfiguration extends Configuration, AutoCloseable {
    ...
    static DynamicConfiguration getDynamicConfiguration() {
        ...
        return optional.orElseGet(() -> getExtensionServiceLoader(DynamicConfigurationFactory.class)
                .getDefaultExtension()
